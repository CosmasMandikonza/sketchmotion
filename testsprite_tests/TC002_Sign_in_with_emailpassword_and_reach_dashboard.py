...
async def run_test():
    ...
    try:
        ...
        # -> Navigate to the authentication page (/auth) so the sign-in form can be located.
        await page.goto("http://localhost:5173/auth")
        
        # -> Fill the email field with the test account email and the password, then submit the form.
